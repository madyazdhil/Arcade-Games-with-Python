...
class MyGame(arcade.Window):
    def __init__(self, width, height, title):
        ...
        # Third dot controlled by mouse
        self.position_x_3 = 200
        self.position_y_3 = 200
        self.radius_3 = 15
    ...
    def on_mouse_motion(self, x, y, dx, dy):
        # Move the third dot with the mouse
        self.position_x_3 = x
        self.position_y_3 = y
...
def main():
    window = MyGame(640, 480, "Three Dots Example")
    #import sound here
    laser_sound = arcade.load_sound("soundtrack.mp3")

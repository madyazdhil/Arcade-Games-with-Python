...
# draw the snowman
arcade.draw_circle_filled(300, 450, 60, arcade.color.WHITE)  # bottom circle
arcade.draw_circle_filled(300, 550, 80, arcade.color.WHITE)  # middle circle
arcade.draw_circle_filled(300, 625, 40, arcade.color.WHITE)  # top circle
